...
# Path to tfrecords.
CONFIG.PATH_TO_TFRECORDS = '/data/user-home/saptami/akhil/gitHubRepos/tcc/%s_tfrecords'
...
CONFIG.EVAL.NUM_FRAMES = 5

CONFIG.EVAL.VAL_ITERS = 5
...
CONFIG.EVAL.FRAMES_PER_BATCH = 5
